                ...
                <div class="container d-flex justify-content-center align-items-center">
                    <div class="row">
                        ...
                        <div class="col-12 mt-auto mb-5 text-center">
                            <small>RIRO ROBOTICS Presents</small>

                            <h1 class="text-white mb-5">RIRO WORLD CUP</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                            <div class="services-info">
                                <h2 class="text-white mb-4">About RIRO World Cup 2025</h2>

                                <p class="text-white">RThe RIRO World Cup is a global robotics championship driven by a mission to inspire innovation, collaboration, and STEM education. Organized by passionate educationists from NITI Aayog and ISRO, this event celebrates the spirit of creativity and technological excellence</p>

                                <h6 class="text-white mt-4">Once in a Lifetime Experience</h6>

                                <p class="text-white">The RIRO World Cup goes beyond competition—it’s a platform to shape the future of robotics and AI. Participants gain hands-on experience, showcase groundbreaking ideas, and connect with a global network of innovators.</p>

                                <h6 class="text-white mt-4">Celebrate Innovation Together</h6>

                                <p class="text-white">Join us as we inspire minds, foster collaboration, and bridge the gap between education and industry. Be a part of this transformation journey and tell your friends about the RIRO World Cup. Thank you!</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h2 class="text-center mb-4">Seminars for you</h2>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="pricing-thumb">
                                <div class="d-flex">
                                    <div>
                                        <h1><small>Astronomy Lectures</small></h1><h3><strike>499 </strike> 199 Rs</h3>

                                        <p>Astronomy Lectures by Scientist </p>
                                    </div>

                                    <p class="pricing-tag ms-auto">Save up to <span>60%</span></h2>
                                </div>
                                ...
                                <a class="link-fx-1 color-contrast-higher mt-4" href="registration_participents.php">
                        ...
                        <div class="col-lg-6 col-12 mt-4 mt-lg-0">
                            <div class="pricing-thumb">
                                <div class="d-flex">
                                    <div>
                                        <h1><small>Ethical Hacking</small></h1><h3> <strike>1999 </strike> 499 Rs</h3>

                                        <p>Ethical Hacking by a certified Hacker</p>
                                    </div>
                                    <p class="pricing-tag ms-auto">Save up to <span>75%</span></h2>
                                </div>

                                <ul class="pricing-list mt-3">
                                    <li class="pricing-list-item">bring laptop if possible</li>

                                    <li class="pricing-list-item">Hands on practice</li>

                                    <li class="pricing-list-item">Live Hacking Demonstration</li>

                                    <li class="pricing-list-item">premium content</li>
                                    
                                    <li class="pricing-list-item">live doubt Section </li>
                                </ul>
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            <div class="tab-content shadow-lg mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-ContactMap" role="tabpanel" aria-labelledby="nav-ContactMap-tab">
                                    <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30168.06316662101!2d72.8400112194938!3d19.06339045684416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c8df0b86ea1b%3A0xce7eea4b1bbdf296!2sBandra%20Kurla%20Complex%2C%20Bandra%20East%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1732308986605!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <div class="site-footer-top">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <h2 class="text-white mb-lg-0">RIRO WORLD CUP</h2>
                        </div>
...
Apartment complex in Mumbai, Maharashtra</p>

                        <a class="link-fx-1 color-contrast-higher mt-3" href="https://maps.app.goo.gl/v8McKFJnYaPVMwAD8">
                            <span>Our Maps</span>
                            <svg class="icon" viewBox="0 0 32 32" aria-hidden="true"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="16" cy="16" r="15.5"></circle><line x1="10" y1="18" x2="16" y2="12"></line><line x1="16" y1="12" x2="22" y2="18"></line></g></svg>
                        </a>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12 mt-5">
                            <p class="copyright-text">Copyright © 2036 RIRO WORLD CUP Company</p>
                        </div>
